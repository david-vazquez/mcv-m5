...
da_saturation_scale_range          = 1.         # Saturation channel scale Rnd on range (1/s , s)
da_exposure_scale_range            = 1.         # Exposure channel scale Rnd on range (1/s , s)
da_hue_shift_range                 = 0.         # Hue channel shift Rnd on range (-360*h , 360*h)
